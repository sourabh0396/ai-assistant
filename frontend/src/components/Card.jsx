...
export default function Card({ image }) {
  ...
  const {
    ...
    backEndImage, setBackEndImage, selectdImage, setSelectdImage } = useContext(userDataContext);
  return (
    <div className={`w-[80px] h-[160px] lg:w-[150px] lg:h-[250px] bg-[#161212e1] border-2
     border-[#0000ff80] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-gray-900
      ...
      ${selectdImage == image ? "border-4 border-white shadow-2xl shadow-gray-900" : null}`}
      onClick={() => {
